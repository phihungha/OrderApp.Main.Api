...
namespace OrderApp.Main.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250829042827_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderApp.Main.Api.Domain.Entities.UserEntities.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OrderApp.Main.Api.Domain.Entities.UserEntities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OrderApp.Main.Api.Domain.Entities.UserEntities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderApp.Main.Api.Domain.Entities.UserEntities.PaymentMethod", b =>
                {
                    b.HasOne("OrderApp.Main.Api.Domain.Entities.UserEntities.User", null)
                        ...
                        .HasForeignKey("OrderApp.Main.Api.Domain.Entities.UserEntities.PaymentMethod", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
